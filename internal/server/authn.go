...
//		if err != nil {
//			s.logger.Error("Fail to parse request", "error", err)
//			helper.WriteJson(w, http.StatusBadRequest, "ok")
//			return
//		}
//
//		result, err := authn.RegisterWithEmail(ctx, request, s.logger, s.AuthnService, s.TokenService)
//		if err != nil {
//			s.logger.Error("Fail to sign up with email", "error", err)
...
//		}
//
//		user, token, err := authn.LogInWithEmail(ctx, request, s.logger, s.AuthnService, s.TokenService)
//		if err != nil {
//			s.logger.Error("Fail to logger in with email", "error", err)
//			helper.WriteJson(w, http.StatusInternalServerError, "")
//			return
//		}
