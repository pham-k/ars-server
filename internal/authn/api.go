...
func RegisterWithEmail(ctx context.Context, input RequestSignUpWithEmail, log log.Log,
...
func LogInWithEmail(ctx context.Context, input RequestLogInWithEmail, log log.Log,
